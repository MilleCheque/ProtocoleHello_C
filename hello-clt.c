...
int main(int argc, char** argv)
{
  ...
  getTCPsap(&svrSAP,&svrSAPlen,namesvr,service);//On stock le serveur que l'on veut joindre

  /* connexion au serveur */
  int cx;
  if ( (cx=socket(AF_INET, SOCK_STREAM,0))==-1 ) { //on a créer un flux qui communique via TCP
